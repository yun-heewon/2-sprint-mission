...
router.post('/create', index_1.default.authenticate('access-token', { session: false }), createArticle);
router.patch('/update/:id', index_1.default.authenticate('access-token', { session: false }), updateArticle);
router.delete('/:id', index_1.default.authenticate('access-token', { session: false }), deleteArticle);
router.get('/my-article', index_1.default.authenticate('access-token', { session: false }), getMyArticleList);
router.get('/', index_1.default.authenticate('access-token', { session: false }), getArticleList);
