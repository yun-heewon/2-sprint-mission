...
router.post('/create', index_1.default.authenticate('access-token', { session: false }), createProduct);
router.patch('/update/:id', index_1.default.authenticate('access-token', { session: false }), updateProduct);
router.delete('/:id', index_1.default.authenticate('access-token', { session: false }), deleteProduct);
router.get('/my-product', index_1.default.authenticate('access-token', { session: false }), getMyProductList);
router.get('/', index_1.default.authenticate('access-token', { session: false }), getProductList);
router.get('/me/liked-products', index_1.default.authenticate('access-token', { session: false }), getLikedProductList);
