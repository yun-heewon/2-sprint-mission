...
router.post('/products/:productId', passport_1.default.authenticate('access-token', { session: false }), uploadLikeProduct);
router.post('/articles/:articleId', passport_1.default.authenticate('access-token', { session: false }), uploadLikeArticle);
