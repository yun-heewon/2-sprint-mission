...
router.post('/:productId/create', index_1.default.authenticate('access-token', { session: false }), createComment);
router.patch('/:commentId/update', index_1.default.authenticate('access-token', { session: false }), updateComment);
router.delete('/:commentId', index_1.default.authenticate('access-token', { session: false }), deleteComment);
